            ...
            >
              <Calendar
                ...
                classNames={{
                  ...
                  dropdown_month:
                    "flex items-center font-bold text-sm bg-slate-50 rounded-lg px-2 py-1 mr-1",
                  dropdown_year:
                    "flex items-center font-bold text-sm bg-slate-50 rounded-lg px-2 py-1",
                  dropdown:
                    "p-1 focus:bg-white transition-colors cursor-pointer outline-none",
                }}
              />
            </PopoverContent>
          </Popover>
