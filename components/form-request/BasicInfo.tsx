      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-6">
        ...
        <div className="group">
          ...
          <FormSelect
            ...
            className="w-full bg-transparent border-b border-slate-200 py-3 text-gray-700 text-sm font-bold uppercase outline-none focus:border-[#0c479a] transition-all appearance-none cursor-pointer"
          />
        </div>
      </div>
    </div>
