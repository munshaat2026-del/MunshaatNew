          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex gap-0 border border-white/5 w-fit bg-white/[0.02]">
              {[Linkedin, Twitter, Instagram].map((Icon, i) => (
                <Link key={i} href="#" className="w-10 h-10 flex items-center justify-center border-r border-white/5 hover:bg-white hover:text-slate-950 transition-all last:border-r-0">
                  <Icon size={16} />
                </Link>
              ))}
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 leading-tight group-hover:text-slate-300">
                  King Fahd Road, KAFD Tower 4,<br />Amman, Jordan
                </span>
              </div>
              ...
              <p className="text-sm centert text-white/80 wrap-break-word">
                {isAr ? (
                  <>
                    ...
                    <Link href={nurembergUrl} target="_blank" className="underline hover:text-[#0c479a] transition-colors">
                      Nuremberg Group
                    </Link>
                  </>
                ) : (
