...
const OfficeBookingPage = () => {
  ...
  return (
    <div
      className="min-h-screen bg-white pt-32 pb-20 px-6 font-sans text-slate-900"
      dir="ltr"
    >
          ...
          <div className="md:col-span-3 grid grid-cols-4 md:grid-cols-1 gap-2">
            {images.map((img, idx) => (
              ...
              >
                <img
                  src={img}
                  className="w-full h-full md:h-[146px] object-cover "
                  alt={`Thumbnail ${idx}`}
                />
                {activeImage === idx && (
                  <div className="absolute inset-0 bg-[#0c479a]/10"></div>
                )}
              </div>
            ))}
          </div>
          ...
          <div className="lg:col-span-8 space-y-20">
            ...
            <section className="space-y-6">
              ...
              <p className="text-slate-500 text-sm font-bold uppercase tracking-[0.15em] leading-[2.2] max-w-3xl border-l-2 border-slate-100 pl-8">
                Designed for high-performance leadership. This executive suite
                integrates state-of-the-art ergonomic architecture with
                breathtaking panoramic city views. Features include soundproof
                glass partitions, reception connectivity, and direct access to
                shared executive boardrooms.
              </p>
            </section>
            ...
            <section className="space-y-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-0 border-t border-l border-slate-100">
                {features.map((f, i) => (
                  <div
                    key={i}
                    className="flex flex-col gap-4 p-8 border-r border-b border-slate-100 hover:bg-slate-50 transition-colors"
                  >
                ...
                <table className="w-full text-left border-collapse">
                  <tbody>
                    {[
                      ...
                      >
                        <td className="px-8 py-6 text-[9px] font-black text-slate-400 uppercase tracking-widest w-1/3 bg-slate-50/50">
                          {label}
                        </td>
                        <td className="px-8 py-6 text-[10px] font-black text-slate-900 uppercase tracking-widest ">
                          {val}
                        </td>
                      </tr>
                    ))}
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#0a0f1a] p-10 border-l-4 border-[#0c479a] sticky top-32 space-y-10 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <div>
                  <label className="block text-[8px] font-black uppercase text-slate-500  mb-3">
                    Protocol Duration
                  </label>
                  <select className="w-full p-4 bg-white/5 border border-white/10 text-white text-[10px] font-black uppercase tracking-widest outline-none focus:border-[#0c479a] transition-colors appearance-none cursor-pointer">
                    ...
                    <option className="bg-slate-900">
                      12 Months [DISCOUNT 10%]
                    </option>
                    <option className="bg-slate-900">
                      24 Months [FREE MONTH]
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="date"
                    className="w-full p-4 bg-white/5 border border-white/10 text-white text-[10px] font-black uppercase tracking-widest outline-none focus:border-[#0c479a] transition-colors appearance-none"
                  />
                </div>
                ...
                <div className="pt-8 border-t border-white/10 space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xl font-black text-[#0c479a] ">
                      $1,250.00
                    </span>
                  </div>
                </div>

                <button className="w-full bg-[#0c479a] hover:bg-white hover:text-black text-white font-black py-6 text-[10px] uppercase  transition-all flex items-center justify-center gap-4 group">
                ...
                <p className="text-center text-[7px] font-black text-slate-600 uppercase ">
