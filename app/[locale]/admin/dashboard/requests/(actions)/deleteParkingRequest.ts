...
import { deleteParkingRequest } from "@/app/server/parkingsRequests/services";

export async function deleteParkingRequestAction(ParkingrequestId:string) {
  try {
      ...
      const result = await deleteParkingRequest(ParkingrequestId);
