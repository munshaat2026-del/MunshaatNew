export const parkingdata = {
  en: {
    parkingHero: {
      ...
      titleLine1: "Parking",
      titleLine2: "Services",
      desc: `We provide well-organized and equipped parking facilities that ensure easy access and movement, with efficient space management for a safe and comfortable experience.`,
  ...
  ar: {
    parkingHero: {
      ...
      titleLine1: "خدمات ",
      titleLine2: "المواقف",
      desc: `نوفر مواقف مركبات منظمة ومجهزة تضمن سهولة الوصول والحركة، مع إدارة فعالة للمساحات بما يوفر تجربة مريحة وآمنة للزوار والمستأجرين.`,
      ctaPrimary: "طلب موقف",
