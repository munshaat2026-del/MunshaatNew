  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        ...
        >
          {/* Decorative Notch - تفصيل ميكانيكي صغير */}
        ...
        {/* Visual Indicator - خط رفيع في الأسفل يتحرك مع التبديل */}
        <div 
