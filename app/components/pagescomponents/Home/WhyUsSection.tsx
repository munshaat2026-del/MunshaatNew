      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-24">
        ...
        <div className="flex-1 w-full relative">
          <div className="grid grid-cols-12 grid-rows-6 h-[600px] gap-0">
            {/* Image 1: Tall & Sharp */}
            <div className={`col-span-7 row-span-5 bg-slate-100 z-10 overflow-hidden shadow-2xl ${isAr ? 'border-l-4' : 'border-r-4'} border-white`}>
              <img
            ...
            {/* Image 2: Wide & Offset */}
            <div className={`${isAr ? 'col-end-9 col-span-8' : 'col-start-5 col-span-8'} row-start-3 row-span-4 bg-slate-200 border-t-4 border-white overflow-hidden shadow-2xl`}>
              <img
          ...
          <div className={`absolute -bottom-8 ${isAr ? '-right-8' : '-left-8'} bg-black text-white px-8 py-4 text-[9px] font-black uppercase tracking-[0.4em] z-20`}>
            {data.label}
          </div>
        </div>
