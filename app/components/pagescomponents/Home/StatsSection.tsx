  ...
  return (
    <section className="py-32 bg-white px-6 md:px-16 border-t border-slate-100">
      <div className="max-w-7xl mx-auto">
        <div
          className={`mb-16 flex items-center justify-between border-b border-slate-900 pb-8`}
        >
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 ${isAr ? "border-r" : "border-l"} border-slate-900`}
        >
          {data.items.map((stat, i) => {
            ...
            return (
              ...
              >
                <span
                  className={`absolute top-4 ${isAr ? "left-6" : "right-6"} text-[8px] font-black text-slate-200 group-hover:text-[#0c479a] transition-colors uppercase tracking-widest`}
                >
                  {stat.code}
                </span>
                ...
                <div className="space-y-8 relative z-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] font-black text-slate-400 uppercase  group-hover:text-slate-900 transition-colors">
                      {stat.lab}
                    </p>
                  </div>
                </div>
