        ...
        <div className="flex gap-3 w-full md:w-auto">
          <div className="relative flex-1 md:w-80">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-100 pl-12 pr-4 py-3 rounded-lg text-sm font-bold outline-none focus:border-[#2383c9]"
            />
          </div>
          <button className="bg-slate-900 text-white px-8 py-3 rounded-lg font-black text-[10px] uppercase ">
            Inquire
          </button>
        </div>
      </div>
