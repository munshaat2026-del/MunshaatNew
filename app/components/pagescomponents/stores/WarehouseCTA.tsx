    ...
    <footer className="py-40 px-6 bg-white border-t-4 border-slate-900 overflow-hidden relative">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="flex flex-col items-center text-center space-y-12">
          ...
          <p className="max-w-2xl text-slate-400 text-xs md:text-sm font-bold uppercase  leading-loose">
            Engage our Industrial Assets team for a comprehensive facility audit
            and a lease framework tailored to your logistics architecture.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-0 w-full max-w-2xl border border-slate-900 mt-12">
            <button className="bg-slate-900 text-white px-8 py-8 font-black text-[10px] uppercase  hover:bg-white hover:text-slate-900 transition-all duration-500 flex items-center justify-center gap-4 group border-r border-slate-900">
              <Phone
                size={16}
            ...
            <button className="bg-white text-slate-900 px-8 py-8 font-black text-[10px] uppercase  hover:bg-slate-50 transition-all duration-500 flex items-center justify-center gap-4 group">
