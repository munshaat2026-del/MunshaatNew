    ...
    <header className="relative min-h-screen flex items-center overflow-hidden bg-[#0a0f1a] border-b border-slate-900 py-32 md:py-40">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 w-full space-y-12">
        ...
        <div className="max-w-2xl border-l-2 border-slate-800 pl-8 space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-0 border border-white/10 w-fit bg-white/5 backdrop-blur-sm shadow-2xl">
             <button className="bg-white text-slate-900 px-10 py-5 font-black text-[10px] uppercase tracking-[0.3em] hover:bg-[#0c479a] hover:text-white transition-all duration-500 flex items-center gap-3 group">
               Deploy Operations <ChevronRight size={14} className="group-hover:translate-x-2 transition-transform" />
             </button>
             <button className="border-l border-white/10 text-white px-10 py-5 font-black text-[10px] uppercase tracking-[0.3em] hover:bg-white/10 transition-all">
               View Floorplans
             </button>
          </div>
        </div>
      ...
      <div className="absolute bottom-12 right-12 hidden lg:block opacity-30">
        <div className="text-right space-y-1">
          <p className="text-[8px] font-black text-white uppercase tracking-widest leading-none">Global Logistics Node</p>
          <p className="text-[10px] font-black text-white uppercase tracking-[0.3em]">KSA // RIY // IND_ZONE_4</p>
        </div>
      </div>
    </header>
  );
