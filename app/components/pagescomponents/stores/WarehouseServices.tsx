...
export default function WarehouseServices({
  ...
  const features = [
    { title: "WMS Support", desc: "Integrated digital ecosystem", Icon: Zap },
    {
      ...
      desc: "Advanced hazard control",
      Icon: ShieldCheck,
    },
    {
      title: "Heavy-Load Flooring",
      desc: "70kN/sqm industrial grade",
      Icon: HardHat,
    },
    {
      title: "Fleet Parking",
      desc: "Dedicated logistics units",
      Icon: CheckCircle2,
    },
  ];
        ...
        <div className="space-y-12">
          <div className="space-y-6">
            ...
            <p className="text-slate-400 font-bold text-xs uppercase tracking-widest leading-loose max-w-lg">
              Beyond space, we provide high-specification assets built to
              international industrial standards. Optimized for 24/7
              high-frequency fleet operations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-t border-l border-slate-100">
            {features.map((feature, i) => (
              <div
                key={i}
                className="group p-8 border-r border-b border-slate-100 transition-colors hover:bg-slate-50"
              >
                <feature.Icon
                  size={20}
                  className="mb-4 text-slate-300 group-hover:text-[#0c479a] transition-colors"
                />
          ...
          <div className="aspect-[4/5] overflow-hidden bg-slate-100 border border-slate-100 relative shadow-2xl">
            ...
            >
              <div className="space-y-2">
                <p className="text-6xl font-black tracking-tighter leading-none uppercase  ">
                  24/7
                </p>
                <p className="text-[9px] font-black uppercase  opacity-80 border-t border-white/20 pt-4">
