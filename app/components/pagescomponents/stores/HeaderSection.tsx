...
export default function StoresHeader({ primaryColor, locale }: StoresHeaderProps) {
  const isArabic = locale === "ar";

  return (
    <header className="relative h-[60vh] flex items-center justify-start bg-[#0a0f1a] overflow-hidden border-b border-slate-900">
      {/* Background with Retail Architectural Treatment */}
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt={isArabic ? "محلات تجارية" : "Commercial Stores"}
        />
