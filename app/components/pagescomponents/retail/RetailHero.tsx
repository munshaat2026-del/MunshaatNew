  ...
  return (
    ...
    <header className="relative min-h-screen flex items-center justify-start px-6 md:px-20 overflow-hidden bg-[#0a0f1a] border-b border-slate-900 py-32">
      ...
      <div className="absolute top-40 right-10 hidden lg:block text-right space-y-1 opacity-40">
        ...
        <p className="text-[10px] font-black text-[#0c479a] uppercase tracking-widest  ">
          High-Traffic Retail_01
        </p>
      </div>
      ...
      <div className="relative z-10 max-w-5xl space-y-12">
        ...
        <div className="max-w-xl border-l-2 border-slate-800 pl-8 space-y-8">
          <p className="text-slate-400 text-xs md:text-sm font-bold uppercase  leading-loose  ">
          ...
          <div className="flex flex-col sm:flex-row gap-0 border border-white/10 w-fit bg-white/5 backdrop-blur-sm">
            <button className="bg-white text-slate-900 px-8 md:px-12 py-5 font-black text-[10px] uppercase  hover:bg-[#0c479a] hover:text-white transition-all duration-500 flex items-center gap-4 group">
              Acquire Space{" "}
              <ChevronRight
                size={14}
            ...
            <button className="border-l border-white/10 text-white px-8 md:px-12 py-5 font-black text-[10px] uppercase  hover:bg-white/10 transition-all">
              Global Portfolio
            </button>
          </div>
        </div>
