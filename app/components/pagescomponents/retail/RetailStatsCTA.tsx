        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 border border-slate-900">
          ...
          <div className="lg:col-span-7 p-12 md:p-20 space-y-16 border-b lg:border-b-0 lg:border-r border-slate-900">
            <div className="space-y-6">
              <div className="flex items-center gap-3 text-[#0c479a]">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.5em]">Tenant Ecosystem</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter leading-[0.9] text-slate-900">
                WHY BRANDS <br />
                <span className="text-transparent" style={{ WebkitTextStroke: `1.5px ${primaryColor}` }}>TRUST ROYAL.</span>
              </h2>
              <p className="text-slate-400 text-[11px] font-bold uppercase tracking-[0.2em] leading-loose max-w-md">
                We don't just lease space; we architect high-performance retail environments designed for visibility and operational continuity.
              </p>
            </div>
          ...
          <div className="lg:col-span-5 relative bg-slate-900 overflow-hidden group">
            ...
            <div className="absolute bottom-10 right-10 bg-white p-6 border border-slate-200 shadow-2xl">
               <p className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-1">Portfolio Snapshot</p>
               <p className="text-[10px] font-black uppercase text-slate-900">Premium Commercial Hub_04</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 bg-slate-900 p-12 md:p-20 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-0">
              <button 
                className="bg-[#0c479a] text-white px-12 py-6 text-[10px] font-black uppercase tracking-[0.4em] hover:bg-white hover:text-black transition-all"
              >
                Contact Leasing
              </button>
              <button 
                className="border border-white/20 text-white px-12 py-6 text-[10px] font-black uppercase tracking-[0.4em] hover:bg-white/10 transition-all"
              >
                Tenant Guide
              </button>
            </div>
