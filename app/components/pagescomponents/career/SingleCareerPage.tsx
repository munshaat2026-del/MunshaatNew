      ...
      <main className="max-w-7xl mx-auto px-6 py-24">
        ...
        <header className="mb-16">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[10px] font-bold uppercase  text-[#0c479a]">
          ...
          <div className="lg:col-span-7 space-y-20">
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-[11px] font-bold uppercase  text-slate-400">
            ...
            <section className="bg-slate-900 text-white p-8 md:p-12 relative overflow-hidden rounded-sm">
              <h3 className="text-[10px] font-bold uppercase  text-slate-500 mb-10">
