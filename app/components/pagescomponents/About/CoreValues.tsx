    ...
    <section className="py-40 px-6 bg-white border-b border-slate-100">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 flex flex-col md:flex-row md:items-end justify-start gap-8">
          ...
          <p
            className={`text-slate-400 text-[10px] font-bold uppercase  max-w-[240px] leading-loose border-slate-100 ${isAr ? "border-r-2 pr-6" : "border-l-2 pl-6"}`}
          >
            {data.desc}
          </p>
        </div>
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-slate-100 auto-rows-[280px] ${isAr ? "border-r" : "border-l"}`}
        >
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <p className="text-slate-400 leading-relaxed font-bold text-[11px] fonts tracking-widest max-w-md group-hover:text-slate-600 transition-colors">
                    {val.d}
                  </p>
                </div>
