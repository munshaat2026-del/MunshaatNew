        ...
        <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 uppercase tracking-tighter">
              Leadership <span className="font-light italic text-slate-400">&</span> Excellence
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, i) => (
            <div key={i} className="group relative cursor-pointer">
              ...
              {/* Image Box - Sharp Corners for Architectural Feel */}
              <div className="relative aspect-[4/5] overflow-hidden bg-slate-200">
                ...
                <div 
                  className="absolute top-0 right-0 w-12 h-12 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-all duration-300"
              ...
              {/* The Inset Card - تداخل بسيط يعطي تميز */}
              <div className="relative -mt-12 mx-4 p-6 bg-white shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-slate-50 transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-xl">
