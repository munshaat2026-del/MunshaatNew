    ...
    <section className="py-24 px-6 md:px-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto relative group">
        ...
        >
          ...
          {/* Main Content Column */}
          <div className="w-full md:w-[70%] p-4 md:p-20 relative z-10">
            {/* Decorative Corner */}
            <div
              className={`absolute top-0 ${isAr ? "left-0" : "right-0"} w-24 h-24 opacity-10`}
            >
              <div
                className={`absolute top-8 ${isAr ? "left-8" : "right-8"} w-px h-16 bg-white`}
              ></div>
              <div
                className={`absolute top-8 ${isAr ? "left-8" : "right-8"} h-px w-16 bg-white`}
              ></div>
            </div>
          ...
          <div
            className="absolute top-0 left-0 w-full h-0.75 scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-center"
